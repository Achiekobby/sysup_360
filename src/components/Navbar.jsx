    ...
    >
      <div className="container mx-auto px-6 py-4">
        <div className="flex items-center justify-between">
          ...
          >
            <div className="w-8 h-8 rounded-lg bg-gradient-to-br from-[#F47D11] to-[#F4733A] flex items-center justify-center">
          ...
          <motion.button
            ...
            whileTap={{ scale: 0.95 }}
            className="px-6 py-2 bg-gradient-to-r from-[#F47D11] to-[#F4733A] rounded-full text-white font-semibold hover:shadow-lg hover:shadow-[#F47D11]/50 transition-all"
          >
            Get Started
          </motion.button>
        </div>
